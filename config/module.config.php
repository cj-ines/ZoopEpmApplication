...
return array(
    'router' => array(
        'routes' => array(
            ...
            // using the path /zoop-epm-application/:controller/:action
            'zoop-epm-application' => array(
                'type'    => 'Literal',
                'options' => array(
                    'route'    => '/zoop-epm-application',
                    'defaults' => array(
                        '__NAMESPACE__' => 'ZoopEpmApplication\Controller',
                        'controller'    => 'Index',
                        'action'        => 'index',
                    ),
                ),
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
            ...
            'zoop-epm-application/index/index' => __DIR__ . '/../view/zoop-epm-application/index/index.phtml',
